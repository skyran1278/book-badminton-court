...
const bookBadmintonCourt = () => {
  ...
  courtIdAndTimes.forEach(({ courtId, courtTime }) => {
    people.forEach((person) => {
      ...
      fetch(
        `https://nd01.xuanen.com.tw/MobilePlace/MobilePlace?tFlag=3&PlaceType=1&BookingPlaceID=${courtId}&BookingDate=${bookDate}&BookingTime=${courtTime}`,
        {
          method: 'GET',
          headers: {
...
場地時間: ${bookDate} ${courtTime}:00 羽 ${courtIdNamePair[courtId]}
